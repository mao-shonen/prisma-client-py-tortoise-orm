__doc__ = '''
This file is generated by the `prisma-client-py-tortoise-orm (0.1.2)`,
...
class User(Model):
    ...
    group: fields.ForeignKeyRelation[typing.Union['Group', typing.Any]] = fields.ForeignKeyField(source_field='groupId', model_name='models.Group', to_field='id', related_name='user_group')
